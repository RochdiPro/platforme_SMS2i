...
public class AddUserFormationHandler  implements RequestHandler<AddUserFormationCommand, AddUserFormationResponse> {
    ...
    public AddUserFormationHandler(UserFormationRepositoryService userFormationRepositoryService, ModelMapper modelMapper) {
    ...
    public AddUserFormationResponse handle(AddUserFormationCommand command) {
        ...
        String id = String.valueOf(this.userFormationRepositoryService.add(userFormation));
